...
class DataGenerator(object):
    ...
    def reinit(self, save_path):
        ...
        cPickle.dump(self.samples, open(save_path, 'wb'))
...
if __name__ == '__main__':
    data_dir = '/home/j/deep-clustering/data/train/'
    # data_dir = 'speech/'
    gen = DataGenerator(data_dir, batch_size=64)
    print 'begin generate data'
    gen.reinit(save_path='/home/j/deep-clustering/data/pkl_data/train/train_01.pkl')
